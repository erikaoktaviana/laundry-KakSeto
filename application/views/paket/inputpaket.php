    ...
    <div class="container" style="margin-bottom: 50px;">
        <div class="row">
                <div class="col-md-10 offset-md-1 mt-2">
                    <div class="card">
                        <div class="card-body">
                        <form action="<?= base_url('LaundryController/simpanPaket'); ?>" method="post">
                            <div class="mb-3">
                                <label class="form-label">Jenis Paket</label>
                                <input type="text" name="jenisPaket" class="form-control" autocomplete="off">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Biaya</label>
                                <input type="text" name="biaya" class="form-control" autocomplete="off">
                            </div>
                            <div class="mb-3">
